...
bool Renderer::initialize(FlockSimulationCPU& simulation) {
    if (!glfwInit()) {
...
void Renderer::render(FlockSimulationCPU& simulation) {
    glViewport(0, 0, window_width, window_height);
...
void Renderer::setup_callbacks(FlockSimulationCPU* sim) {
